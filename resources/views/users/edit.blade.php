    ...
    <aside class="">
        <div class="">
            <div class="add-new mb-3">
                <a href="{{ route('users.index') }}"><button class="btn btn-sm btn-primary" id="add-new-user-btn"><i
            ...
            <div class="add-users-form-section add-new-section" id="add-users-form-section">
                <form action="{{ route('users.update', $data->id) }}" class="form" method="POST" enctype="multipart/form-data">
                    @csrf @method('PATCH')
                    <div class="row mb-3">
                        <div class="col-6">
                            <div class="mb-3">
