    ...
    <aside class="">
        <div class="">
            <div class="add-new mb-3">
                <a href="{{ route('bodies.index') }}"><button class="btn btn-sm btn-primary" id="add-new-btn"><i
            ...
            <div class="add-form-section add-new-section" id="add-form-section">
                <form action="{{ route('bodies.store') }}" class="form" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="row mb-3">
                        <div class="col-12">
                            <div class="mb-3">
