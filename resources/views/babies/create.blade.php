    ...
    <aside class="">
        <div class="">
            <div class="add-new mb-3">
                <a href="{{ route('babies.index') }}"><button class="btn btn-sm btn-primary" id="add-new-btn"><i
            ...
            <div class="add-form-section add-new-section" id="add-form-section">
                <form action="{{ route('babies.store') }}" class="form" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="row mb-3">
                        <div class="col-12">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('title') is-invalid @enderror"
                                    ...
                                    placeholder="Title of the baby growth article">
                                @error('title')
