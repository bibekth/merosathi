    ...
    <aside class="">
        <div class="">
            <div class="add-new mb-3">
                <a href="{{ route('article-sections.index',['article_id' => $data->article->id]) }}"><button class="btn btn-sm btn-primary" id="add-new-user-btn"><i
            ...
            <div class="add-form-section add-new-section" id="add-form-section">
                <form action="{{ route('article-sections.update', $data->id) }}" class="form" method="POST" enctype="multipart/form-data">
                    @csrf @method('PATCH')
                    <div class="row mb-3">
                         <div class="col-12">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('article') is-invalid @enderror"
                                    id="article" name="article" value="{{ $data->article->title }}" readonly>
                                @error('article')
